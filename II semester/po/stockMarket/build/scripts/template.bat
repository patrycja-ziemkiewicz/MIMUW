...
set CLASSPATH=%APP_HOME%\lib\template-1.0-SNAPSHOT.jar


@rem Execute template
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEMPLATE_OPTS%  -classpath "%CLASSPATH%" pl.edu.mimuw.Main %*
...
if not ""=="%TEMPLATE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
